...
void WorldSession::HandleWrapItemOpcode(WorldPacket& recvData)
{
	...
	if (gift->GetEntry() == sConfigMgr->GetIntDefault("huanhua.id", 21831)) {//�û���Ʒ����  Ӳ����
		...
		if (eSolt == EQUIPMENT_SLOT_MAINHAND || eSolt == EQUIPMENT_SLOT_OFFHAND) {
			...
			if (_player->IsTwoHandUsed()) {
				_player->SetUInt32Value(PLAYER_VISIBLE_ITEM_1_ENTRYID + EQUIPMENT_SLOT_MAINHAND * MAX_VISIBLE_ITEM_OFFSET, _itemID);// ��ħ˫��
			}
			else {
				...
				if (_player->GetItemByPos(INVENTORY_SLOT_BAG_0, EQUIPMENT_SLOT_OFFHAND) && !_player->GetItemByPos(INVENTORY_SLOT_BAG_0, EQUIPMENT_SLOT_MAINHAND))
					_player->SetUInt32Value(PLAYER_VISIBLE_ITEM_1_ENTRYID + EQUIPMENT_SLOT_OFFHAND * MAX_VISIBLE_ITEM_OFFSET, _itemID);// ����ͷ�
				if (_player->GetItemByPos(INVENTORY_SLOT_BAG_0, EQUIPMENT_SLOT_OFFHAND) && _player->GetItemByPos(INVENTORY_SLOT_BAG_0, EQUIPMENT_SLOT_MAINHAND)) {
					_player->SetUInt32Value(PLAYER_VISIBLE_ITEM_1_ENTRYID + eSolt * MAX_VISIBLE_ITEM_OFFSET, _itemID);// ����ͷ�
				}
				if (!_player->GetItemByPos(INVENTORY_SLOT_BAG_0, EQUIPMENT_SLOT_OFFHAND) && !_player->GetItemByPos(INVENTORY_SLOT_BAG_0, EQUIPMENT_SLOT_MAINHAND)) {
					return;//��ֻ�ֶ�û������ֱ�ӷ���
				}
		...
		//"ShowUPFrame#32838|1|51395|182|6780|184|0|0|1|2|3|0|0|2|1|3|0|0|0|0|88|����÷|10|1"
		oss << message << "#"<< _itemID<<"|";
    ...
    switch (item->GetEntry())
    {
       ...
       // case 17307: item->SetEntry(17308); break; ������߱���Ʒ����������
       // case 21830: item->SetEntry(21831); break;  ����������ڻû�����������
