...
PzxConfigMgr* PzxConfigMgr::instance()
{
...
bool PzxConfigMgr::GetValueHelper(const char* name, ACE_TString &result)
{
...
bool PzxConfigMgr::LoadInitial(char const* file)
{
	ASSERT(file);
...
bool PzxConfigMgr::LoadMore(char const* file)
{
	ASSERT(file);
	ASSERT(_config);
...
bool PzxConfigMgr::LoadData(char const* file)
{
...
std::string PzxConfigMgr::GetStringDefault(const char* name, const std::string &def, bool logUnused /*= true*/)
{
	ACE_TString val;
...
bool PzxConfigMgr::GetBoolDefault(const char* name, bool def, bool logUnused /*= true*/)
{
	ACE_TString val;
...
int PzxConfigMgr::GetIntDefault(const char* name, int def, bool logUnused /*= true*/)
{
	ACE_TString val;
...
float PzxConfigMgr::GetFloatDefault(const char* name, float def, bool logUnused /*= true*/)
{
	ACE_TString val;
...
std::list<std::string> PzxConfigMgr::GetKeysByString(std::string const& name)
{
	GuardType guard(_configLock);
